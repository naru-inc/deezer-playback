        ...
        [actions
         addObject:[DeezerItemViewControllerAction
                    actionWithTitle:@"Play" block:^{
                        [((DeezerSampleAppDelegate *)[UIApplication sharedApplication].delegate).playerViewController
                         setPlayable:(DZRObject<DZRPlayable>*)self startIndex:0];
                    }]];
    }
               ...
               actionWithTitle:@"Play Top" block:^{
                   [self
                    ...
                    withRequestManager:itemVC.manager callback:^(DZRObjectList *tracks, NSError *error) {
                        ...
                        [((DeezerSampleAppDelegate *)[UIApplication sharedApplication].delegate).playerViewController
                         setPlayable:playable startIndex:0];
                    }];
               }]]];
}
@end
