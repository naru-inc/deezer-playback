...
@property (nonatomic, strong) UIViewController *playerPart;
@end
...
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    self.playerPart = [[DeezerAudioPlayerController alloc] init];
    self.playerPart.tabBarItem =
        [[UITabBarItem alloc] initWithTitle:@"Player" image:[UIImage imageNamed:@"note"] tag:2];

    UITabBarController* rootVC = [[UITabBarController alloc] init];
    [rootVC setViewControllers:@[ self.registeredPart, self.playerPart, self.unregisteredPart] animated:NO];
...
{
    return ((DeezerAudioPlayerController*)self.playerPart);
}
