...
- (id)initWithPlayable:(id<DZRPlayable>)playable startIndex:(NSUInteger)startIndex
{
    ...
    if (self) {
        [self setPlayable:playable startIndex:startIndex];
    }
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self updateTrackInformation:self.player.currentTrack];
}
...
- (void)setPlayable:(id<DZRPlayable>)playable startIndex:(NSUInteger)startIndex
{
    ...
    _previousButton.enabled = self.isTwoWayPlayable = [(NSObject*)playable.iterator conformsToProtocol:@protocol(DZRPlayableRandomAccessIterator)];
}
...
- (void)setTrack:(DZRTrack*)track
{
    ...
    [self updateTrackInformation:track];
}

- (void)updateTrackInformation:(DZRTrack *)track
{
